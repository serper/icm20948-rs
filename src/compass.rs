...
use crate::register::slave_reg as slave_reg;
use crate::types::slv_bits as slv_bits;
    ...
    D: DelayMs<u32>,
{
    ...
    pub fn register_aux_compass(&mut self, compass_type: CompassType, compass_i2c_addr: u8) -> Result<(), Icm20948Error> {
        ...
        let mut compass_config = CompassConfig::default();
        compass_config.compass_type = compass_type;
        compass_config.compass_i2c_addr = compass_i2c_addr;
        compass_config.compass_state = CompassState::Initialized;
    ...
    pub fn setup_compass(&mut self, compass_type: CompassType, compass_i2c_addr: u8) -> Result<CompassConfig, Icm20948Error> {
        ...
        if compass_type != CompassType::AK09916 {  // AK09916 no tiene ROM de sensibilidad
    ...
    fn write_secondary_i2c(&mut self, channel: SecondaryI2cChannel, addr: u8, reg: u8, data: u8) -> Result<(), Icm20948Error> {
        // Determinar los registros según el canal
